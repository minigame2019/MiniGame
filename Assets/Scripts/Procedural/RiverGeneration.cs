...
/**
    ...
    public void GenerateRivers(int levelDepth, int levelWidth, Dictionary<Vector2, TerrianChunk> levelData)
    {
    ...
    private Vector3 ChooseRiverOrigin(int levelDepth, int levelWidth, Dictionary<Vector2, TerrianChunk> levelData)
    {
        bool found = false;
        int randomZIndex = 0;
        int randomXIndex = 0;
    ...
    private void BuildRiver(int levelDepth, int levelWidth, Vector3 riverOrigin, Dictionary<Vector2, TerrianChunk> levelData)
    {
