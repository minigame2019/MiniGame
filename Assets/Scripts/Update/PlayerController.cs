...
public class PlayerController : MonoBehaviour, IDamageable
{
    ...
    public void SetSelected()
    {
        ...
        var ai = GetComponent<m_AIDestinationSetter>();
        if (ai != null)
        {
            ai.enabled = true;
        }
    ...
    {
        mCurrentQuest = quest;
        mCurrentQuest.Initialize(this);

        if (questUI != null)
        {
            questUI.SetQuest(mCurrentQuest);
        }
    ...
    public void SetQuestCompleted(Quest quest)
    {
        ...
        questUI.QuestSolved(mCurrentQuest);
    ...
    public void InteractWithItem()
    {
        if (mInteractItem != null)
        {
            ...
            // Check quest if it is completed or quest tasks
            if (mCurrentQuest != null)
            {
                mCurrentQuest.CheckCompleted();
            }          
        }
    }
